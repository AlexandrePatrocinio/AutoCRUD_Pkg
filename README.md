...
Para saber como usá-lo favor consultar o [wiki](https://github.com/AlexandrePatrocinio/AutoCRUD_Pkg/wiki) ou o repositório de exemplo chamado "api" (https://github.com/AlexandrePatrocinio/api) em meu github.
...
Pour savoir comment l'utiliser, veuillez consulter le [wiki](https://github.com/AlexandrePatrocinio/AutoCRUD_Pkg/wiki) ou l'exemple de référentiel appelé "api" (https://github.com/AlexandrePatrocinio/api) sur mon github.
...
To learn how to use it, please see the [wiki](https://github.com/AlexandrePatrocinio/AutoCRUD_Pkg/wiki) or the example repository called "api" (https://github.com/AlexandrePatrocinio/api) on my github.
